...
function bookSeats($seatNumbers, $conn) {
    foreach ($seatNumbers as $seatNumber) {
        $sql = "UPDATE movie3 SET status = 'occupied' WHERE seat_number = '$seatNumber'";
        $conn->query($sql);
    }
}
...
<head>
    ...
    <title>Movie Ticket Booking - Godzilla x Kong: The New Empire</title>
...
<body>
    <header>
        <h1>Godzilla x Kong: The New Empire - Seat Selection</h1>
    </header>
