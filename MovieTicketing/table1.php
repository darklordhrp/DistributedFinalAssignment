...
function bookSeats($seatNumbers, $conn) {
    foreach ($seatNumbers as $seatNumber) {
        $sql = "UPDATE table1 SET status = 'occupied' WHERE seat_number = '$seatNumber'";
        $conn->query($sql);
    }
}
...
<head>
    ...
    <title>Movie Ticket Booking - Avengers: Endgame</title>
...
<body>
    <header>
        <h1>Avengers: Endgame - Seat Selection</h1>
    </header>
