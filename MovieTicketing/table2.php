...
function bookSeats($seatNumbers, $conn) {
    foreach ($seatNumbers as $seatNumber) {
        $sql = "UPDATE movie2 SET status = 'occupied' WHERE seat_number = '$seatNumber'";
        $conn->query($sql);
    }
}
...
<head>
    ...
    <title>Movie Ticket Booking - Bahubali: The Beginning</title>
...
<body>
    <header>
        <h1>Bahubali: The Beginning - Seat Selection</h1>
    </header>
